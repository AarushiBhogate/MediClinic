...
namespace MediClinic.Controllers
{
    public class SchedulesController : Controller
    {
        ...
        public SchedulesController(MediClinicDbContext context)
        {
            _context = context;
        }
        ...
        {
            var mediClinicDbContext = _context.Schedules.Include(s => s.Appointment).Include(s => s.Physician);
        ...
        public async Task<IActionResult> Create([Bind("ScheduleId,PhysicianId,AppointmentId,ScheduleDate,ScheduleTime,ScheduleStatus")] Schedule schedule)
        {
